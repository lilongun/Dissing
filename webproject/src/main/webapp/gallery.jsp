        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                for( i=0; i<data.list.length; i++){
                    ...
                    $subjectH4 = $('<h4 class="no"><a target="_blank" class="ellipsis" href="postinfo.jsp?id=' + data.list[i].id + '&subject='+ data.list[i].subject +'">' + data.list[i].subject +'</a><a href="gallery.jsp?typeId='+ data.list[i].typeId +'&typeName='+ data.list[i].typeName +'">'+ $typeName +'</a></h4>');
