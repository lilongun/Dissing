   	   ...
   	   <div class="main">
   	      <div class="register_account">
    		   ...
    		   <form>
    			 <div class="col_1_of_2 span_1_of_2">
					 <input id="id" type="hidden" />
		   			 <div><input id="username" disabled type="text" value="用户名" onfocus="if (this.value == '用户名') {this.value = '';}" onblur="if (this.value == '') {this.value = '用户名';}"></div>
					 <div><input id="nickName" disabled type="text" value="昵称" onfocus="if (this.value == '昵称') {this.value = '';}" onblur="if (this.value == '') {this.value = '昵称';}"></div>
					 <div><input id="email" disabled type="text" value="电子邮箱" onfocus="if (this.value == '电子邮箱') {this.value = '';}" onblur="if (this.value == '') {this.value = '电子邮箱';}"></div>
		    	 </div>
		    	  <div class="col_1_of_2 span_1_of_2">
					<%--<div><input id="password" disabled type="text" value="密码" onfocus="if (this.value == '密码' || this.value == '修改密码') {this.value = '';}" onblur="if (this.value == '') {this.value = '密码';}"></div>--%>
					<div><input id="phoneNumber" disabled type="text" value="电话号码" onfocus="if (this.value == '电话号码') {this.value = '';}" onblur="if (this.value == '') {this.value = '电话号码';}"></div>
		    		<div><input id="address" disabled type="text" value="地址" onfocus="if (this.value == '地址') {this.value = '';}" onblur="if (this.value == '') {this.value = '地址';}"></div>
		      ...
		      <!--<button id="submitButton" class="grey">提交</button>-->
				   ...
				   <script>
                           $.ajax({
                               url: 'http://localhost:9099/auth/getUserInfoById/<%=ownerId%>',
                               dataType: "json",
                               async: false,
							   /*headers: {
